...
// ╔══════════════════════════════════════════════════════════════════════════╗
// ║  VENDORED — verbatim from canonical erc-8004 reference contracts          ║
// ║                                                                          ║
// ║  source_repo:  https://github.com/erc-8004/erc-8004-contracts             ║
// ║  source_file:  contracts/ValidationRegistryUpgradeable.sol                ║
// ║  vendored_at:  2026-04-25                                                 ║
// ║  rationale:    No canonical Base Sepolia deployment of the Validation     ║
// ║                Registry exists at vendor time. We deploy our own          ║
// ║                instance at T031, sourced verbatim here. When the          ║
// ║                canonical team ships a Base Sepolia deployment, swap       ║
// ║                the address inside ValidationAdapterV1 — this file is      ║
// ║                untouched (CLAUDE.md Rule 7 adapter pattern).              ║
// ║                                                                          ║
// ║  DO NOT EDIT this file manually. To re-vendor: replace from the          ║
// ║  canonical source above and update vendored_at.                          ║
// ╚══════════════════════════════════════════════════════════════════════════╝
